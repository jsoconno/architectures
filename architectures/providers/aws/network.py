...
class PrivateSubnet(_Network):
    ...
    _default_label = "Private Subnet"

class CloudMap(_Network):
    _icon = "cloud-map.png"
    _default_label = "Cloud Map"
