...
class CloudendureMigration(_Migration):
	...
	_default_label = "Cloudendure Migration"

class MigrationHub(_Migration):
	_icon = "migration-hub.png"
	_default_label = "Migration Hub"
