...
class LoggingWhite(_Governance):
	...
	_default_label = "Logging White"

class Groups(_Governance):
	_icon = "groups.png"
	_default_label = "Groups"

class Logging(_Governance):
	_icon = "logging.png"
	_default_label = "Logging"
