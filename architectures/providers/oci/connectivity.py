...
from architectures.providers import _Oci

class _Connectivity(_Oci):
	_service_type = "connectivity"
	_icon_dir = "icons/oci/connectivity"

class FastConnect(_Connectivity):
	_icon = "fast-connect.png"
	_default_label = "Fast Connect"
...
class DisconnectedRegionsWhite(_Connectivity):
	...
	_default_label = "Disconnected Regions White"
