...
class WorkflowWhite(_Monitoring):
	...
	_default_label = "Workflow White"

class Workflow(_Monitoring):
	_icon = "workflow.png"
	_default_label = "Workflow"
